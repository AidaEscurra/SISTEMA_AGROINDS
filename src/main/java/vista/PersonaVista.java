...
import componentes.JLabelGenerico; // <--- AGREGADO
import componentes.JtextFieldGenerico; // <--- AGREGADO
...
public class PersonaVista extends JDialogGenerico {
	...
	// <--- AGREGADOS: Atributos para los campos del formulario
	...
	// <--- AGREGADOS: Getters necesarios para el PersonaController
