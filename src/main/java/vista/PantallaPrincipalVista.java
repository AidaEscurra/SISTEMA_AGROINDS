...
public class PantallaPrincipalVista extends JFrame {
	...
	public PantallaPrincipalVista() {
		...
		// 2. MENÚ MOVIMIENTO / PROCESOS (Para la producción fabril)
		...
		btnFuncionario.setBounds(25, 45, 150, 159);
		...
		btnMateriaPrima.setBounds(221, 45, 150, 159);
		...
		btnProduccion.setBounds(428, 45, 159, 159);
